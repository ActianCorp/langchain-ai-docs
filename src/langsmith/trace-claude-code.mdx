...
<Note> If you are migrating from the previous recommended version of with manually created stop hooks, see [this section](#migrating-from-the-manual-stop-hook). </Note>
