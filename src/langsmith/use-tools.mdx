...
When you create a custom tool, it is saved to the current prompt only. You can save it to a workspace-wide [tool registry](#manage-tools-with-the-registry) to reuse it across prompts and sessions.
...
The Playground includes a [workspace](/langsmith/administration-overview#workspaces)-scoped **tool registry** for saving and reusing tools across prompts and sessions. When you create a custom tool, it is saved to the current prompt only. To make it available across all prompts in your workspace, save it to the registry.
