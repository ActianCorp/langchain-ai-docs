...
See [Contract burndown](/langsmith/usage-visibility#contract-burndown) for details on viewing your prepaid contract consumption.
...
The first step of any optimization process is to understand current usage. See [View usage](/langsmith/usage-visibility) for details on the usage graph, granular usage, invoices, and contract burndown.

LangSmith usage is measured per workspace, because workspaces often represent development environments or teams within an organization.
