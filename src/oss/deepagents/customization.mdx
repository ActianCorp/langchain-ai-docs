...
In addition to [built-in tools](/oss/langchain/overview#core-capabilities) for planning, file management, and subagent spawning, you can provide custom tools:
...
You can use [skills](/oss/langchain/overview) to provide your deep agent with new capabilities and expertise.
