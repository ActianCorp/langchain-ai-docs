...
The Apify Store contains thousands of prebuilt Actors. Here are examples of other popular Actors you can use with the document loader:
...
For more information, see the [LangChain MCP documentation](/oss/langchain/mcp) and [Apify MCP server](https://mcp.apify.com).
