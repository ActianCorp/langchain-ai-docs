...
This guide provides a quick overview for getting started with the ActianVectorAI [vector store](/oss/python/integrations/vectorstores#overview). For a detailed listing of all Actian VectorAI DB features, paramaters, and configurations, head to the [Actian VectorAI DB LangChain API reference](https://pypi.org/project/langchain-actian-vectorai/).
...
<Callout icon="edit">
    [Edit this page on GitHub](https://github.com/langchain-ai/docs/edit/main/src/oss/python/integrations/vectorstores/actian_vectorai.mdx) or [file an issue](https://github.com/langchain-ai/docs/issues/new/choose).
</Callout>
</div>
