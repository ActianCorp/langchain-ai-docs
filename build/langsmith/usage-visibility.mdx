...
| [Invoices](#invoices) | Settings > Billing > Invoices | All org members | Paid cloud plans only |
...
For more details on trace retention tiers, see [Data retention](/langsmith/administration-overview#data-retention).
