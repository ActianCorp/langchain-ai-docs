...
<Info>
Available for [Cloud](/langsmith/cloud) (with an externally-managed MongoDB instance), [Hybrid](/langsmith/hybrid), and [Self-hosted](/langsmith/self-hosted) deployments.
</Info>
