...
See the [Quickstart](/oss/langchain/quickstart/) and [Customization guide](/oss/deepagents/customization/) to get started.
...
See the [Installation instructions](/oss/langchain/quickstart) and [Quickstart guide](/oss/langchain/quickstart) to get started with LangChain.
...
<CardGroup cols={2}>
    <Card title="Agents Quickstart" icon="rocket" href="/oss/langchain/quickstart">
