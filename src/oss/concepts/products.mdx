...
The [Deep Agents SDK](/oss/langchain/overview) builds on top of LangGraph and adds planning capabilities, file systems for context management, the ability to spawn subagents, and more.
...
Use the [Deep Agents SDK](/oss/langchain/overview) when:
...
| Streaming | [Agent Streaming](/oss/langchain/streaming) | [Streaming](/oss/langgraph/streaming) | [Streaming](/oss/deepagents/streaming) |

## Learn more

- [LangChain overview](/oss/langchain/overview)
- [LangGraph overview](/oss/langgraph/overview)
- [Deep Agents overview](/oss/langchain/overview)
