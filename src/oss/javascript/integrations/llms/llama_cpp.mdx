...
cd llama3
```
Now we need to go to the Meta AI [`llama-models` repository](https://github.com/meta-llama/llama-models). In the repo, there are instructions to download the model of your choice, and you should use the unique URL that was received in your email.
