...
First, you need to sign up on the Jina website and get the [API token from Jina](https://jina.ai/embeddings). You can copy model names from the dropdown in the api playground.
