...
See a [usage example](/oss/integrations/chat/azure)
...
```
See a [usage example](/oss/integrations/llms/azure).
...
```
See a [usage example](/oss/integrations/vectorstores/azure_aisearch).
...
```
See a [usage example](/oss/integrations/vectorstores/azure_cosmosdb_nosql).
...
npm install @langchain/azure-cosmosdb @langchain/core
```
See a [usage example](/oss/integrations/vectorstores/azure_documentdb).
...
npm install @langchain/azure-cosmosdb @langchain/core
```
See a [usage example](/oss/integrations/llm_caching/azure_cosmosdb_nosql).
...
```
See a [usage example for the Azure Blob Storage](/oss/integrations/document_loaders/web_loaders/azure_blob_storage_container).

```typescript
import { AzureBlobStorageContainerLoader } from "@langchain/community/document_loaders/web/azure_blob_storage_container";
```
See a [usage example for the Azure Files](/oss/integrations/document_loaders/web_loaders/azure_blob_storage_file).
